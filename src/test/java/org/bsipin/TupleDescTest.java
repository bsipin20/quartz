...
public class TupleDescTest extends SimpleDbTestBase {
    ...
    @Test public void nameToId() {
        ...
        for (int len: lengths) {
            ...
            try {
                td.nameToId("foo");
                Assertions.fail("foo is not a valid field name");
            ...
            try {
                td.nameToId(null);
                Assertions.fail("null is not a valid field name");
            } catch (NoSuchElementException e) {
                // expected to get here
            }
            ...
            try {
                td.nameToId(prefix);
                Assertions.fail("no fields are named, so you can't find it");
            } catch (NoSuchElementException e) {
                // expected to get here
            }
        }
